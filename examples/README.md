...
npm `agent-payment-policy@0.14.0` does not include `examples/`. This package
version is `0.15.0` and is not on the npm registry until a later GitHub release
publishes it. Until then, pack this repository:
